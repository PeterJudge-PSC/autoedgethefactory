...
/** -- main -- **/
oServiceManager = cast(ABLSession:Instance:SessionProperties:Get(ServiceManager:ServiceManagerType), IServiceManager).

/* shutdown the session */
cast(oServiceManager:StartService(SecurityManager:SecurityManagerType), ISecurityManager):EndSession().
