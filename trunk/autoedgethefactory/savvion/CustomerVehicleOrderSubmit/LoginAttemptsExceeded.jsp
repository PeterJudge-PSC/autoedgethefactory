...
<%! String _PageName = "LoginAttemptsExceeded"; %>
<%! String __webAppName = "CustomerVehicleOrderSubmit"; %>
<% pageContext.setAttribute( "contextPath", request.getContextPath()+"/"); %>

<title>LoginAttemptsExceeded</title>
...
<input name="crtPage" type="hidden" value="LoginAttemptsExceeded"><input name="crtApp" type="hidden" value="CustomerVehicleOrderSubmit"><input name="activityMode" type="hidden" value="procReq"><input type="hidden" name="nextPage" value="Start.jsp">
...
<!-- Content --> 
    ...
    <div align="left" id="">
      <br clear="all">
<fieldset name="fsRetriesExceeded">
        <legend><sbm:message key="LoginAttemptsExceeded.fieldset.fsRetriesExceeded.label"></sbm:message></legend>
        <div align="center" id="">
          <font color="#339966" face="Segoe UI" size="4">
            <i>You have exceeded the number of login attempts allowed, and your session is being ended for security reasons. Please try again later.</i>
          </font>
        </div>
      </fieldset>
      <br clear="all">
...
<tr>
<td class="ApBtnSpace">
<input type="submit" name="SB_Name" id="btn-complete" class="ApScrnButton" onMouseOver="this.className='ApScrnButtonHover';" onMouseOut="this.className='ApScrnButton';" onClick="clickedButton=this.name;this.onsubmit = new Function('return false');" value="<bizsolo:getLabel name='ExitOnRetries' type='LINK'/>"></td>
<td class="ApBtnSpace">
