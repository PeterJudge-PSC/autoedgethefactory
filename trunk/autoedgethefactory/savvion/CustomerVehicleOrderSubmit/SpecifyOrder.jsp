...
<input name="crtPage" type="hidden" value="SpecifyOrder"><input name="crtApp" type="hidden" value="CustomerVehicleOrderSubmit"><input name="activityMode" type="hidden" value="procReq"><input type="hidden" name="nextPage" value="Start.jsp">
...
<tr>
<td class="ApBtnSpace">
<input type="submit" name="SB_Name" id="btn-complete" class="ApScrnButton" onMouseOver="this.className='ApScrnButtonHover';" onMouseOut="this.className='ApScrnButton';" onClick="clickedButton=this.name;this.onsubmit = new Function('return false');" value="<bizsolo:getLabel name='Connection 18' type='LINK'/>"></td>
<td class="ApBtnSpace">
...
<script language="JavaScript">
<!--
var allWidgets = [{widget:'TextField1', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'OrderNum', dataSlotType:'LONG'}, target:{type:'DATASLOT', dataSlotName:'OrderNum', dataSlotType:'LONG'}, dsType:'LONG', service:'false'}
];
var businessObjects = [];
