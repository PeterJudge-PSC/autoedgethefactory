...
<%! String _PageName = "RegisterCustomer"; %>
...
<input name="crtPage" type="hidden" value="RegisterCustomer"><input name="crtApp" type="hidden" value="CustomerVehicleOrderSubmit"><input name="activityMode" type="hidden" value="procReq"><input type="hidden" name="nextPage" value="Start.jsp">
...
<!-- Content --> 
    ...
    <div align="left" id="">
      <br clear="all">
<br clear="all">
<fieldset name="fsRegister">
        <legend><sbm:message key="RegisterCustomer.fieldset.fsRegister.label"></sbm:message></legend>
        <div align="center" id="">
          <font color="#008080" face="Segoe UI" size="4">
            <i>Please register yourself in our system to continue</i>
          </font>
          <font color="#008080" face="Segoe UI" size="3">
            <i>.</i>
          </font>
          <br clear="all">
<img border="0" id="imgUnderConstruction" width="500" height="417" src="images/under_construction_blue.png">
          <br clear="all">
<font color="#008080" face="Segoe UI" size="4">
            <b>
              <i>This functionality is under construction - please contact a dealer directly.</i>
            </b>
          </font>
          <br clear="all">
<input class="ApScrnButton" name="SB_Name" id="btnReturn" type="submit" value="<bizsolo:getLabel name='ReturnToLogin' type='LINK'/>" onMouseOut="this.className='ApScrnButton';" onMouseOver="this.className='ApScrnButtonHover';" onClick="clickedButton=this.name;this.onsubmit = new Function('return false');">
...
formWidgetHandler = new FormWidgetHandler(allWidgets,{processName:'CustomerVehicleOrderSubmit',adapletCache:{}});
 });
 }
