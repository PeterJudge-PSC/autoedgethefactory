...
<%! String _PageName = "registeredUserSelectAction"; %>
<%! String __webAppName = "CustomerVehicleOrderSubmit"; %>
<% pageContext.setAttribute( "contextPath", request.getContextPath()+"/"); %>

<title>registeredUserSelectAction</title>
<!-- Javascript -->
...
<body class="apbody yui-skin-sam" onUnload="pwr.removePakBizSoloBeanFromCache('<%=session.getId()%>', onSuccess);" onLoad="setCheckBoxStyleForIE();hideControls();beforeInitControls();initControls();initTabs();sbm.utils.onDOMReady();onLoad();">
...
<input name="crtPage" type="hidden" value="registeredUserSelectAction"><input name="crtApp" type="hidden" value="CustomerVehicleOrderSubmit"><input name="activityMode" type="hidden" value="procReq"><input type="hidden" name="nextPage" value="Start.jsp">
...
<!-- Content --> 
    ...
    <div align="center">
      ...
      <br clear="all">
<br clear="all">
<fieldset id="fsOrderId">

        <legend>Order ID</legend>
        <div align="center">

          <font color="#008080" face="Segoe UI" size="4">
            <i>Please enter an existing order number to recall that order's details, or leave blank for a new order.</i>
          </font>
          <br clear="all">
<sfe:widget name="sbm.textfield" id="TextField1" args="{'type':'text', 'size':32, 'maxlength':5, 'readonly':false, 'disabled':false, 'validationType':'integer', 'validation':{'validateOn':['blur'], 'isRequired':false, 'useCharacterMasking':false, 'minValue':'0', 'maxValue':'9999'}, 'textfieldRequiredMsg':'Invalid Entry', 'toolTip':'Existing order id', 'tabOrder':'0'}" />
...
<tr>
<td class="ApBtnSpace">
<input type="submit" name="SB_Name" id="btn-complete" class="ApScrnButton" onMouseOver="this.className='ApScrnButtonHover';" onMouseOut="this.className='ApScrnButton';" onClick="clickedButton=this.name;this.onsubmit = new Function('return false');" value="<bizsolo:getLabel name='Connection28' type='LINK'/>"></td>
<td class="ApBtnSpace">
...
<script language="JavaScript">
<!--
var allWidgets = [{widget:'TextField1', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'orderid', dataSlotType:'LONG'}, target:{type:'DATASLOT', dataSlotName:'orderid', dataSlotType:'LONG'}, dsType:'LONG', service:'false'}
];
var businessObjects = [];
