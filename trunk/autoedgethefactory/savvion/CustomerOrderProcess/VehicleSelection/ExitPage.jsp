...
<input name="crtPage" type="hidden" value="ExitPage"><input name="crtApp" type="hidden" value="VehicleSelection"><input name="activityMode" type="hidden" value="procReq"><input type="hidden" name="nextPage" value="Start.jsp">
