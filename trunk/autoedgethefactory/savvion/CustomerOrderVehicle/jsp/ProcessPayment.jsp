...
<%! String _PageName = "Process Payment"; %>
<%! String __webAppName = "CustomerOrderVehicle"; %>
<% pageContext.setAttribute( "contextPath", request.getContextPath()+"/"); %>
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="CreditApproval,CustomerCreditLimit,CustomerCreditLimit,OrderAmount,CustomerEmail"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="" dso="CustomerEmail,OrderAmount,CustomerCreditLimit,CreditApproval"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="CustomerEmail,OrderAmount,CustomerCreditLimit,CreditApproval"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="CustomerEmail,OrderAmount,CustomerCreditLimit,CreditApproval" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:if test='<%= ! _PageName.equals(request.getParameter("_PageName")) %>'>
    ...
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="CustomerEmail,OrderAmount,CustomerCreditLimit,CreditApproval"></bizsolo:executeAction>
</bizsolo:if>
...
<input name="_PageName" type="hidden" value="Process Payment">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="15%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.Process Payment.instruction"></sbm:message></td>
</tr>
<tr>
      ...
      <tbody>
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <font color="#000000">
              <Label class="ApSegDataslotLabel" for="checkBox1"><sbm:message key="CreditApproval"></sbm:message></Label>
            </font>
          </td>
          <td class="ApSegDataVal" colspan="2" width="50%" rowspan="1" valign="top">
...
<script>addValue("CreditApproval", '<bizsolo:value name="CreditApproval"></bizsolo:value>');</script>
        ...
        <tr>
          <td class="(default)" width="100" rowspan="1" colspan="1" valign="top">
            <font color="#000000">
              <Label class="ApSegDataslotLabel" for=""><sbm:message key="dataslot.CustomerCreditLimit.label"></sbm:message></Label>
            </font>
          </td>
          <td class="(default)" colspan="2" width="50%" rowspan="1" valign="top">
            <sfe:widget name="sbm.textfield" id="TextField1" args="{'type':'text', 'size':32, 'maxlength':50, 'readonly':false, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'Savvion text field widget.', 'tabOrder':'0'}" />
        ...
        <tr>
          <td class="(default)" width="100" rowspan="1" colspan="1" valign="top">
            <font color="#000000">
              <Label class="ApSegDataslotLabel" for="textField2"><sbm:message key="OrderAmount"></sbm:message></Label>
            </font>
          </td>
          <td class="(default)" width="50%" rowspan="1" colspan="1" valign="top">
            <input class="ApInptTxt" type="text" id="textField2" name="OrderAmount" size="30" maxlength="256" value="<bizsolo:value name='OrderAmount'/>" alt="number|0|bok">
    <div style="display:none" id="textField2Error"><div><font color="red"><span class="error" id="textField2ErrorMsg"></span><a href="#" onclick="textField2ErrorMsgClose();return false;"><img border="0" src="<c:out value='${contextPath}'/>bpmportal/css/apptheme01/images/close.gif"></a></font></div></div>
          ...
          <td class="(default)" width="50%" rowspan="1" colspan="1" valign="top"></td>
        </tr>
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <font color="#000000">
              <Label class="ApSegDataslotLabel" for="textField1"><sbm:message key="CustomerEmail"></sbm:message></Label>
            </font>
          </td>
          <td class="ApSegDataVal" width="50%" rowspan="1" colspan="1" valign="top">
            <input class="ApInptTxt" type="text" id="textField1" name="CustomerEmail" size="20" maxlength="256" value="<bizsolo:value name='CustomerEmail'/>" alt="email">
...
<script language="JavaScript">
<!--
var allWidgets = [{widget:'TextField1', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'CustomerCreditLimit', dataSlotType:'LONG'}, target:{type:'DATASLOT', dataSlotName:'CustomerCreditLimit', dataSlotType:'LONG'}, dsType:'LONG', service:'false'}
];
var businessObjects = [];
...
sbm.utils.onFormSubmit = function() {
        ...
        try{
         ...
         document.form.action='<%=response.encodeURL("ProcessPayment.jsp")%>';
