...
<%! String _PageName = "Financing Denied"; %>
...
<input name="_PageName" type="hidden" value="Financing Denied">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="15%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.Financing Denied.instruction"></sbm:message></td>
</tr>
<tr>
...
sbm.utils.onFormSubmit = function() {
        ...
        try{
         ...
         document.form.action='<%=response.encodeURL("FinancingDenied.jsp")%>';
