...
<%! String _PageName = "ProcessBuildError"; %>
...
<input name="_PageName" type="hidden" value="ProcessBuildError">
...
sbm.utils.onFormSubmit = function() {
        ...
        try{
         ...
         document.form.action='<%=response.encodeURL("ProcessBuildError.jsp")%>';
