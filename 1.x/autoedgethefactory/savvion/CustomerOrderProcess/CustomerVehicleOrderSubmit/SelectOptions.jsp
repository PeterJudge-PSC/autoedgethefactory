...
<input name="crtPage" type="hidden" value="SelectOptions"><input name="crtApp" type="hidden" value="CustomerVehicleOrderSubmit"><input name="activityMode" type="hidden" value="procReq"><input type="hidden" name="nextPage" value="Start.jsp">
                    ...
                    <table align="center" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="tblInterior" width="100%">
                      <tbody>
                        <tr>
                          ...
                          <td class="(default)" width="50%" rowspan="1" colspan="1" valign="top">
                            <sfe:widget name="sbm.combobox" id="Combobox1" args="{'size':20, 'readonly':false, 'disabled':false, 'cascade':false, 'level':0, 'required':false, 'validationType':'none', 'validation':{}, 'toolTip':'Savvion Combobox widget.', 'tabOrder':'0'}" />
