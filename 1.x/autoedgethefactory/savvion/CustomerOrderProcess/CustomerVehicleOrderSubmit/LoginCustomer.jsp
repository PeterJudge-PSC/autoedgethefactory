...
<%! String _PageName = "LoginCustomer"; %>
...
<input name="crtPage" type="hidden" value="LoginCustomer"><input name="crtApp" type="hidden" value="CustomerVehicleOrderSubmit"><input name="activityMode" type="hidden" value="procReq"><input type="hidden" name="nextPage" value="Start.jsp">
...
<div class="ApBody" id="div1" name="div1">
        <div align="center" id="">
          <font color="#008000" face="Segoe UI" size="4">
            <i>Please login or register to continue your order.</i>
          </font>
        </div>
        <div align="left" id="">
          <br clear="all">
...
<td class="ApBtnSpace">
<input type="submit" name="SB_Name" id="btn-complete" class="ApScrnButton" onMouseOver="this.className='ApScrnButtonHover';" onMouseOut="this.className='ApScrnButton';" onClick="clickedButton=this.name;this.onsubmit = new Function('return false');" value="<bizsolo:getLabel name='linkRegisterCustomer' type='LINK'/>"></td>
<td class="ApBtnSpace">
