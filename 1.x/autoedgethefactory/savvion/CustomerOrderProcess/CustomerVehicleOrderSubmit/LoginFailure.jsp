...
<input name="crtPage" type="hidden" value="LoginFailure"><input name="crtApp" type="hidden" value="CustomerVehicleOrderSubmit"><input name="activityMode" type="hidden" value="procReq"><input type="hidden" name="nextPage" value="Start.jsp">
...
<!-- Content --> 
    ...
    <div align="center" id="">
      ...
      <br clear="all">
<div class="ApBody" id="div1" name="div1">
        <div align="center" id="">
          <font color="#008000" face="Segoe UI" size="4">
            <i>Your login failed. Please try again to continue your order.</i>
          </font>
          <br clear="all">
<br clear="all">
<br clear="all">
<table align="center" cellpadding="0" cellspacing="0" class="ApSegDataTbl" id="table2" width="55%">
            <tbody>
              <tr>
                <td class="ApSegDataVal" width="15%" rowspan="1" colspan="1" valign="top">
                  <div align="center" id="">
                    <img border="0" id="imgWarningLogo" width="200" height="167" src="images/warning.png">
                  </div>
                </td>
                <td class="ApSegDataVal" width="85%" rowspan="1" colspan="1" valign="top">
                  <br clear="all">
<br clear="all">
<br clear="all">
                    ...
                    <tbody>
                      <tr>
                        <td class="(default)" width="35%" rowspan="1" colspan="1" valign="top">
                          <div align="right" id="">
                            <font color="#808080" face="Segoe UI" size="3">User Name:</font>
                          </div>
                        </td>
                      ...
                      <tr>
                        ...
                        <td class="(default)" width="32" rowspan="1" colspan="1" valign="top">
                          <sfe:widget name="sbm.textfield" id="txtPassword" args="{'type':'Password', 'size':32, 'maxlength':32, 'readonly':false, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'Savvion text field widget.'}" />
...
<tr>
<td class="ApBtnSpace">
<input type="submit" name="SB_Name" id="btn-complete" class="ApScrnButton" onMouseOver="this.className='ApScrnButtonHover';" onMouseOut="this.className='ApScrnButton';" onClick="clickedButton=this.name;this.onsubmit = new Function('return false');" value="<bizsolo:getLabel name='linkRetryLogin' type='LINK'/>"></td>
<td class="ApBtnSpace">
<input type="button" name="bizsite_reset" id="btn-reset" class="ApScrnButton" onMouseOver="this.className='ApScrnButtonHover';" onMouseOut="this.className='ApScrnButton';" onClick="sbm.utils.reset()" value="<bizsolo:getLabel name='RESET_LABEL' type='RESOURCE'/>"></td>
      ...
      <input class="ApInptTxt" type="text" id="txtNumAttempts" name="NumLoginAttempts" size="30" maxlength="256" value="<bizsolo:value name='NumLoginAttempts'/>" alt="number|0|bok">
<script>addHiddenControls("txtNumAttempts");</script>    <div style="display:none" id="txtNumAttemptsError"><div><font color="red"><span class="error" id="txtNumAttemptsErrorMsg"></span><a href="#" onclick="txtNumAttemptsErrorMsgClose();return false;"><img border="0" src="<c:out value='${contextPath}'/>bpmportal/css/app<%= bizManage.getTheme() %>/images/close.gif"></a></font></div></div>
    </div>
...
{
var numAtt = sbm.util.getValue("txtNumAttempts");
numAtt++;
sbm.util.setValue("txtNumAttempts", numAtt);;
}
}
