...
<fieldset name="fsWelcome">
        <legend><sbm:message key="LoginCustomer.fieldset.fsWelcome.label"></sbm:message></legend>
        <div align="center" id="">
...
<tr>
<td class="ApBtnSpace">
<input type="submit" name="SB_Name" id="btn-complete" class="ApScrnButton" onMouseOver="this.className='ApScrnButtonHover';" onMouseOut="this.className='ApScrnButton';" onClick="clickedButton=this.name;this.onsubmit = new Function('return false');" value="<bizsolo:getLabel name='ExistingCustomer' type='LINK'/>"></td>
<td class="ApBtnSpace">
<input type="submit" name="SB_Name" id="btn-complete" class="ApScrnButton" onMouseOver="this.className='ApScrnButtonHover';" onMouseOut="this.className='ApScrnButton';" onClick="clickedButton=this.name;this.onsubmit = new Function('return false');" value="<bizsolo:getLabel name='RegisterCustomer' type='LINK'/>"></td>
<td class="ApBtnSpace">
