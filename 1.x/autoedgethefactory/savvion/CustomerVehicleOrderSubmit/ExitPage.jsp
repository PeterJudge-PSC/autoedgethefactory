...
<input name="crtPage" type="hidden" value="ExitPage"><input name="crtApp" type="hidden" value="CustomerVehicleOrderSubmit"><input name="activityMode" type="hidden" value="procReq"><input type="hidden" name="nextPage" value="Start.jsp">
...
<!-- Content --> 
    ...
    <div align="center" id="">
      ...
      <br clear="all">
<br clear="all">
<fieldset name="fsOrderComplete">
        <legend><sbm:message key="ExitPage.fieldset.fsOrderComplete.label"></sbm:message></legend>
        <div align="center" id="">
