...
<input name="crtPage" type="hidden" value="SelectBrand"><input name="crtApp" type="hidden" value="CustomerVehicleOrderSubmit"><input name="activityMode" type="hidden" value="procReq"><input type="hidden" name="nextPage" value="Start.jsp">
...
<!-- Content --> 
    ...
    <div align="center" id="">
      <img border="0" id="imAETFLogo" width="400" height="69" src="images/aetf_logo.png">
      <br clear="all">
<div class="ApBody" id="div1" name="div1">
        ...
        <div align="left" id="">
          <br clear="all">
<table align="center" cellpadding="0" cellspacing="0" class="(default)" id="table1" width="600">
            <tbody>
              <tr>
                <td class="ApBody" width="165" rowspan="1" colspan="1" valign="top">
...
<tr>
<td class="ApBtnSpace">
<input type="submit" name="SB_Name" id="btn-complete" class="ApScrnButton" onMouseOver="this.className='ApScrnButtonHover';" onMouseOut="this.className='ApScrnButton';" onClick="clickedButton=this.name;this.onsubmit = new Function('return false');" value="<bizsolo:getLabel name='linkSelectModel' type='LINK'/>"></td>
<td class="ApBtnSpace">
<input type="button" name="bizsite_reset" id="btn-reset" class="ApScrnButton" onMouseOver="this.className='ApScrnButtonHover';" onMouseOut="this.className='ApScrnButton';" onClick="sbm.utils.reset()" value="<bizsolo:getLabel name='RESET_LABEL' type='RESOURCE'/>"></td>
      ...
      <br clear="all">
<br clear="all">
<sfe:widget name="sbm.textfield" id="txtBrand" args="{'type':'text', 'size':32, 'maxlength':50, 'readonly':false, 'disabled':false, 'required':true, 'validationType':'none', 'validation':{}, 'toolTip':'Savvion text field widget.'}" />
...
function imgFjordLogo_onMouseDown(eventContext) {
{
...
function imgHindaLogo_onMouseDown(eventContext) {
{
sbm.util.setValue('txtBrand', 'Hinda'); 
//SetDataSlot();
// highlight selected brand, de-emphasise others
sbm.util.hide('imgCheryLogo');
sbm.util.show('imgCheryLogoBw');
sbm.util.show('imgHindaLogo');
sbm.util.hide('imgHindaLogoBw');
sbm.util.hide('imgPotomocLogo');
sbm.util.show('imgPotomocLogoBw');
sbm.util.hide('imgToyolaLogo');
...
function imgPotomocLogo_onMouseDown(eventContext) {
{
sbm.util.setValue('txtBrand', 'Potomoc'); 
// highlight selected brand, de-emphasise others
sbm.util.hide('imgCheryLogo');
sbm.util.show('imgCheryLogoBw');
sbm.util.hide('imgHindaLogo');
...
<script language="JavaScript">
<!--
var allWidgets = [{widget:'txtBrand', bound:'true', editable:'true', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'SelectedVehicleBrand', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'SelectedVehicleBrand', dataSlotType:'STRING'}, dsType:'STRING', service:'false'}
];
var businessObjects = [];
