...
<font color="#008000" face="Segoe UI" size="4">
          ...
          <br clear="all">
<input class="ApScrnButton" name="SB_Name" id="btnReturn" type="submit" value="<bizsolo:getLabel name='linkReturnToLogin' type='LINK'/>" onMouseOut="this.className='ApScrnButton';" onMouseOver="this.className='ApScrnButtonHover';" onClick="clickedButton=this.name;this.onsubmit = new Function('return false');">
