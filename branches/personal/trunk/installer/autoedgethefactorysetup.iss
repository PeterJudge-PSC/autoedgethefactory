...
[InnoIDE_Settings]
LogFile=C:\devarea\staging\aetf\2.x\installer\output\compile.log
LogFileOverwrite=true

[Setup]
InternalCompressLevel=Max
OutputBaseFilename=AutoEdgeTheFactorySetup-2.0.0
...
AppCopyright=Copyright 2012 © Progress Software Corp.
AppName=OpenEdge AutoEdge|TheFactory Application Example
AppVerName=OpenEdge AutoEdge|TheFactory Application Example 2.0.0
...
; Use relative paths?
;SourceDir=..
SourceDir=C:\devarea\staging\aetf\2.x
...
Name: "{group}\AutoEdge\Factory Module\Customer Vehicle Order Process"; Filename: {code:getSBMURL}/sbm/BizSolo/VehicleSelection/Start.jsp; Components: BPM_SERVER_SUPPORT; WorkingDir: {app}; 
...
begin
	...
	MsgAbout	:= 'AutoEdge|TheFactory Setup Version 2.0.0';
