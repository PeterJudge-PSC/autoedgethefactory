...
<!-- Content --> 
    ...
    <div align="left" id="">
      <br clear="all">
<br clear="all">
<fieldset name="fsRetry">
        <legend><sbm:message key="LoginFailure.fieldset.fsRetry.label"></sbm:message></legend>
        <div align="center" id="">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="(default)" width="32" rowspan="1" colspan="1" valign="top">
                          <sfe:widget name="sbm.textfield" id="txtUserName" args="{'type':'Text', 'size':32, 'maxlength':32, 'readonly':false, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'Savvion text field widget.', 'tabOrder':'0'}" />
...
<tr>
<td class="ApBtnSpace">
<input type="submit" name="SB_Name" id="btn-complete" class="ApScrnButton" onMouseOver="this.className='ApScrnButtonHover';" onMouseOut="this.className='ApScrnButton';" onClick="clickedButton=this.name;this.onsubmit = new Function('return false');" value="<bizsolo:getLabel name='RetryLogin' type='LINK'/>"></td>
<td class="ApBtnSpace">
