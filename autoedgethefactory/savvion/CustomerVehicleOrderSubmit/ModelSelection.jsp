...
<%! String _PageName = "ModelSelection"; %>
...
<input name="crtPage" type="hidden" value="ModelSelection"><input name="crtApp" type="hidden" value="CustomerVehicleOrderSubmit"><input name="activityMode" type="hidden" value="procReq"><input type="hidden" name="nextPage" value="Start.jsp">
...
<!-- Content --> 
    ...
    <div align="left" id="">
      <br clear="all">
<fieldset name="fsModel1">
        <legend><sbm:message key="ModelSelection.fieldset.fsModel1.label"></sbm:message></legend>
        <div align="center" id="">
...
<br clear="all">
      ...
      <sfe:widget name="sbm.textfield" id="txtModel" args="{'type':'text', 'size':32, 'maxlength':50, 'readonly':false, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'Savvion text field widget.', 'tabOrder':'0'}" />
...
function txtModel_onChange(eventContext) {
}
