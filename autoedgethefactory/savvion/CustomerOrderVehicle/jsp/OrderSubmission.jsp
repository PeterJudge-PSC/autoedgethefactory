...
<%! String _PageName = "OrderSubmission"; %>
<%! String __webAppName = "CustomerOrderVehicle"; %>
<% pageContext.setAttribute( "contextPath", request.getContextPath()+"/"); %>
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="CustomerEmail,VehicleBrand,VehicleEngine,VehicleAccessoriesOptions,VehicleAccessoriesOptions,VehicleWheelOptions,VehicleWheelOptions,VehicleModel"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="PROCESSNAME" dso="VehicleModel,VehicleWheelOptions,VehicleAccessoriesOptions,VehicleEngine,VehicleBrand,CustomerEmail"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="VehicleModel,VehicleWheelOptions,VehicleAccessoriesOptions,VehicleEngine,VehicleBrand,CustomerEmail"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="VehicleModel,VehicleWheelOptions,VehicleAccessoriesOptions,VehicleEngine,VehicleBrand,CustomerEmail" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:if test='<%= ! _PageName.equals(request.getParameter("_PageName")) %>'>
    ...
    <bizsolo:initDS name="VehicleEngine" type="STRING"></bizsolo:initDS>
    <bizsolo:initDS name="VehicleAccessoriesOptions" type="STRING"></bizsolo:initDS>
    <bizsolo:initDS name="VehicleAccessoriesOptions" type="STRING"></bizsolo:initDS>
    <bizsolo:initDS name="VehicleWheelOptions" type="STRING"></bizsolo:initDS>
    <bizsolo:initDS name="VehicleWheelOptions" type="STRING"></bizsolo:initDS>
    <bizsolo:initDS name="VehicleModel" type="STRING"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="VehicleModel,VehicleWheelOptions,VehicleAccessoriesOptions,VehicleEngine,VehicleBrand,PROCESSNAME,CustomerEmail"></bizsolo:executeAction>
</bizsolo:if>

<title>OrderSubmission</title>
<!-- Javascript -->
...
<input name="_PageName" type="hidden" value="OrderSubmission">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="15%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.OrderSubmission.instruction"></sbm:message></td>
</tr>
<tr>
...
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_DUEDATE_LABEL"></bizsolo:getLabel></td><td width="15%" class="ApSegGenData"><bizsolo:getDS name="bizsite_dueDate"></bizsolo:getDS></td>
      ...
      <tbody>
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <font color="#000000">
              <Label class="ApSegDataslotLabel" for="textField2"><sbm:message key="CustomerEmail"></sbm:message></Label>
            </font>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <input class="ApInptTxt" type="text" id="textField2" name="CustomerEmail" size="20" maxlength="256" value="<bizsolo:value name='CustomerEmail'/>" alt="email">
    <div style="display:none" id="textField2Error"><div><font color="red"><span class="error" id="textField2ErrorMsg"></span><a href="#" onclick="textField2ErrorMsgClose();return false;"><img border="0" src="<c:out value='${contextPath}'/>bpmportal/css/apptheme01/images/close.gif"></a></font></div></div>
        ...
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <font color="#000000">
              <Label class="ApSegDataslotLabel" for="textField3"><sbm:message key="CustomerOrderID"></sbm:message></Label>
            </font>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <input class="ApInptTxt" type="text" id="textField1" name="PROCESSNAME" size="30" maxlength="256" disabled value="<bizsolo:value name='PROCESSNAME'/>">
    <div style="display:none" id="textField1Error"><div><font color="red"><span class="error" id="textField1ErrorMsg"></span><a href="#" onclick="textField1ErrorMsgClose();return false;"><img border="0" src="<c:out value='${contextPath}'/>bpmportal/css/apptheme01/images/close.gif"></a></font></div></div>
        ...
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <font color="#000000">
              <Label class="ApSegDataslotLabel" for="textField8"><sbm:message key="VehicleBrand"></sbm:message></Label>
            </font>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <input class="ApInptTxt" type="text" id="textField8" name="VehicleBrand" size="20" maxlength="256" value="<bizsolo:value name='VehicleBrand'/>">
    <div style="display:none" id="textField8Error"><div><font color="red"><span class="error" id="textField8ErrorMsg"></span><a href="#" onclick="textField8ErrorMsgClose();return false;"><img border="0" src="<c:out value='${contextPath}'/>bpmportal/css/apptheme01/images/close.gif"></a></font></div></div>
        ...
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <font color="#000000">
              <Label class="ApSegDataslotLabel" for="textField9"><sbm:message key="VehicleEngine"></sbm:message></Label>
            </font>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <input class="ApInptTxt" type="text" id="textField9" name="VehicleEngine" size="20" maxlength="256" value="<bizsolo:value name='VehicleEngine'/>">
    <div style="display:none" id="textField9Error"><div><font color="red"><span class="error" id="textField9ErrorMsg"></span><a href="#" onclick="textField9ErrorMsgClose();return false;"><img border="0" src="<c:out value='${contextPath}'/>bpmportal/css/apptheme01/images/close.gif"></a></font></div></div>
          </td>
        </tr>
        <tr>
          <td class="(default)" width="100" rowspan="1" colspan="1" valign="top">
            <font color="#000000">
              <Label class="ApSegDataslotLabel" for="TextField1"><sbm:message key="VehicleAccessoriesOptions"></sbm:message></Label>
            </font>
          </td>
          <td class="(default)" width="100%" rowspan="1" colspan="1" valign="top">
            <sfe:widget name="sbm.list" id="List1" args="{'size':5, 'readonly':false, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'Savvion List widget.', 'tabOrder':'0'}" />
        ...
        <tr>
          <td class="(default)" width="100" rowspan="1" colspan="1" valign="top">
            <font color="#000000">
              <Label class="ApSegDataslotLabel" for="TextField1"><sbm:message key="VehicleWheelOptions"></sbm:message></Label>
            </font>
          </td>
          <td class="(default)" width="100%" rowspan="1" colspan="1" valign="top">
            <sfe:widget name="sbm.list" id="List2" args="{'size':5, 'readonly':false, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'Savvion List widget.'}" />
        ...
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <font color="#000000">
              <Label class="ApSegDataslotLabel" for="textField10"><sbm:message key="VehicleModel"></sbm:message></Label>
            </font>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <input class="ApInptTxt" type="text" id="textField10" name="VehicleModel" size="20" maxlength="256" value="<bizsolo:value name='VehicleModel'/>">
    <div style="display:none" id="textField10Error"><div><font color="red"><span class="error" id="textField10ErrorMsg"></span><a href="#" onclick="textField10ErrorMsgClose();return false;"><img border="0" src="<c:out value='${contextPath}'/>bpmportal/css/apptheme01/images/close.gif"></a></font></div></div>
          </td>
        </tr>
      </tbody>
    </table>
...
<script language="JavaScript">
<!--
var allWidgets = [{widget:'List1', bound:'true', editable:'true', type:'sbm.list', source: {type:'DATASLOT', dataSlotName:'VehicleAccessoriesOptions', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'VehicleAccessoriesOptions', dataSlotType:'STRING'}, dsType:'STRING', service:'false'},
{widget:'List2', bound:'true', editable:'true', type:'sbm.list', source: {type:'DATASLOT', dataSlotName:'VehicleWheelOptions', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'VehicleWheelOptions', dataSlotType:'STRING'}, dsType:'STRING', service:'false'}
];
var businessObjects = [];
...
sbm.utils.onFormSubmit = function() {
        ...
        try{
         ...
         document.form.action='<%=response.encodeURL("OrderSubmission.jsp")%>';
