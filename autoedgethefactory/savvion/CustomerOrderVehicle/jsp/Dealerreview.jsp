...
<%! String _PageName = "Dealer review"; %>
<%! String __webAppName = "CustomerOrderVehicle"; %>
<% pageContext.setAttribute( "contextPath", request.getContextPath()+"/"); %>
<%! java.util.Map myMap; %>
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="OrderApproved,VehicleInStock,VehicleBrand,VehicleOptions,VehicleModel,VehicleEngine,PaintColour,CustomerOrderID,CustomerOrderDate,Customer"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="CustomerOrderID" dso="OrderApproved,VehicleInStock,VehicleBrand,VehicleOptions,VehicleModel,VehicleEngine,PaintColour,CustomerOrderDate,Customer"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="OrderApproved,VehicleInStock,VehicleBrand,VehicleOptions,VehicleModel,VehicleEngine,PaintColour,CustomerOrderDate,Customer"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="OrderApproved,VehicleInStock,VehicleBrand,VehicleOptions,VehicleModel,VehicleEngine,PaintColour,CustomerOrderDate,Customer" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:if test='<%= ! _PageName.equals(request.getParameter("_PageName")) %>'>
    ...
    <bizsolo:initDS name="VehicleInStock" type="BOOLEAN"></bizsolo:initDS>
    <bizsolo:initDS name="VehicleBrand" type="STRING"></bizsolo:initDS>
    <bizsolo:initDS name="VehicleOptions" type="MAP"></bizsolo:initDS>
    <bizsolo:initDS name="VehicleModel" type="STRING"></bizsolo:initDS>
    <bizsolo:initDS name="VehicleEngine" type="STRING"></bizsolo:initDS>
    <bizsolo:initDS name="PaintColour" type="STRING"></bizsolo:initDS>
    <bizsolo:initDS name="CustomerOrderID" type="STRING"></bizsolo:initDS>
    ...
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="OrderApproved,VehicleInStock,VehicleBrand,VehicleOptions,VehicleModel,VehicleEngine,PaintColour,CustomerOrderID,CustomerOrderDate,Customer"></bizsolo:executeAction>
</bizsolo:if>

<title>Dealer review</title>
<!-- Javascript -->
...
<input name="_PageName" type="hidden" value="Dealer review">
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="15%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.Dealer review.instruction"></sbm:message></td>
</tr>
<tr>
      ...
      <tbody>
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <font color="#000000">
              <Label class="ApSegDataslotLabel" for="checkBox1"><sbm:message key="OrderApproved"></sbm:message></Label>
            </font>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <input type="checkbox" value="true" class="ApInptChkBox" name="OrderApproved" id="checkBox1">
<script>addValue("OrderApproved", '<bizsolo:value name="OrderApproved"></bizsolo:value>');</script>
        ...
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <font color="#000000">
              <Label class="ApSegDataslotLabel" for="checkBox2"><sbm:message key="VehicleInStock"></sbm:message></Label>
            </font>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <input type="checkbox" value="true" class="ApInptChkBox" name="VehicleInStock" id="checkBox2">
<script>addValue("VehicleInStock", '<bizsolo:value name="VehicleInStock"></bizsolo:value>');</script>
        ...
        <tr>
          ...
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <input class="ApInptTxt" type="text" id="textField1" name="VehicleBrand" size="20" maxlength="256" value="<bizsolo:value name='VehicleBrand'/>">
    <div style="display:none" id="textField1Error"><div><font color="red"><span class="error" id="textField1ErrorMsg"></span><a href="#" onclick="textField1ErrorMsgClose();return false;"><img border="0" src="<c:out value='${contextPath}'/>bpmportal/css/apptheme01/images/close.gif"></a></font></div></div>
        ...
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <font color="#000000">
              <Label class="ApSegDataslotLabel" for="comboBox1"><sbm:message key="VehicleOptions"></sbm:message></Label>
            </font>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <select size="1" class="ApInptSelect" name="VehicleOptions" id="comboBox1">
    <% myMap = bean.getPropMap("VehicleOptions");if(myMap!=null){pageContext.setAttribute("myMap", myMap);%>
<c:forEach var="mapcurr" items="${myMap}">
            <option value="<c:out value='${mapcurr.key}'/>"><c:set var="MapComboKey" value="${mapcurr.key}"/><sbm:message key='<%= (String)pageContext.getAttribute("MapComboKey") %>'/></option>
    </c:forEach>
<%} %></select>
<% if(myMap!=null){ %><c:forEach var="mapcurr" items="${myMap}">
    <c:if test="${mapcurr.value=='true'}"><script>addValues("VehicleOptions", "<c:out value="${mapcurr.key}" escapeXml="false"/>");</script></c:if>
</c:forEach><%} %>
        ...
        <tr>
          ...
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <input class="ApInptTxt" type="text" id="textField2" name="VehicleModel" size="20" maxlength="256" value="<bizsolo:value name='VehicleModel'/>">
    <div style="display:none" id="textField2Error"><div><font color="red"><span class="error" id="textField2ErrorMsg"></span><a href="#" onclick="textField2ErrorMsgClose();return false;"><img border="0" src="<c:out value='${contextPath}'/>bpmportal/css/apptheme01/images/close.gif"></a></font></div></div>
        ...
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <font color="#000000">
              <Label class="ApSegDataslotLabel" for="textField3"><sbm:message key="VehicleEngine"></sbm:message></Label>
            </font>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <input class="ApInptTxt" type="text" id="textField3" name="VehicleEngine" size="20" maxlength="256" value="<bizsolo:value name='VehicleEngine'/>">
    <div style="display:none" id="textField3Error"><div><font color="red"><span class="error" id="textField3ErrorMsg"></span><a href="#" onclick="textField3ErrorMsgClose();return false;"><img border="0" src="<c:out value='${contextPath}'/>bpmportal/css/apptheme01/images/close.gif"></a></font></div></div>
        ...
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <font color="#000000">
              <Label class="ApSegDataslotLabel" for="textField4"><sbm:message key="PaintColour"></sbm:message></Label>
            </font>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <input class="ApInptTxt" type="text" id="textField4" name="PaintColour" size="20" maxlength="256" value="<bizsolo:value name='PaintColour'/>">
    <div style="display:none" id="textField4Error"><div><font color="red"><span class="error" id="textField4ErrorMsg"></span><a href="#" onclick="textField4ErrorMsgClose();return false;"><img border="0" src="<c:out value='${contextPath}'/>bpmportal/css/apptheme01/images/close.gif"></a></font></div></div>
        ...
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <font color="#000000">
              <Label class="ApSegDataslotLabel" for="textField5"><sbm:message key="CustomerOrderID"></sbm:message></Label>
            </font>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <input class="ApInptTxt" type="text" id="textField5" name="CustomerOrderID" size="20" maxlength="256" disabled value="<bizsolo:value name='CustomerOrderID'/>">
    <div style="display:none" id="textField5Error"><div><font color="red"><span class="error" id="textField5ErrorMsg"></span><a href="#" onclick="textField5ErrorMsgClose();return false;"><img border="0" src="<c:out value='${contextPath}'/>bpmportal/css/apptheme01/images/close.gif"></a></font></div></div>
        ...
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <font color="#000000">
              <Label class="ApSegDataslotLabel" for="CustomerOrderDate"><sbm:message key="CustomerOrderDate"></sbm:message></Label>
            </font>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <div style="display: inline;" id="dateTime1"><bizsolo:getDS type="date" name="CustomerOrderDate" wsName="Dealer review" size="0"></bizsolo:getDS></div>
        ...
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <font color="#000000">
              <Label class="ApSegDataslotLabel" for="textField6"><sbm:message key="Customer"></sbm:message></Label>
            </font>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <input class="ApInptTxt" type="text" id="textField6" name="Customer" size="20" maxlength="256" value="<bizsolo:value name='Customer'/>">
...
sbm.utils.onFormSubmit = function() {
        ...
        try{
         ...
         document.form.action='<%=response.encodeURL("Dealerreview.jsp")%>';
