...
<bizsolo:if test='<%=_PageName.equals(request.getParameter("_PageName")) %>'>
    <bizsolo:setDS name="CustomerCreditLimit,CustomerName,CustomerOrderDate,DealerCode,CreditApproval,SelectedVehicleModel,VehicleBrand"></bizsolo:setDS>
    <bizsolo:choose>
<bizsolo:when test='<%=request.getParameter("bizsite_reassignTask") !=null %>'>
      ...
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKReassignWI" perfMethod="commit" mode="BizSite" dsi="" dso="VehicleBrand,SelectedVehicleModel,CreditApproval,DealerCode,CustomerOrderDate,CustomerName,CustomerCreditLimit"></bizsolo:executeAction>
</bizsolo:when>
<bizsolo:when test='<%=request.getParameter("bizsite_saveTask") !=null %>'>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKUpdateDS" perfMethod="commit" mode="BizSite" dsi="VehicleBrand,SelectedVehicleModel,CreditApproval,DealerCode,CustomerOrderDate,CustomerName,CustomerCreditLimit"></bizsolo:executeAction>
</bizsolo:when>
    <bizsolo:otherwise>
      <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKSetDS" perfMethod="commit" mode="BizSite" dsi="VehicleBrand,SelectedVehicleModel,CreditApproval,DealerCode,CustomerOrderDate,CustomerName,CustomerCreditLimit" res=""></bizsolo:executeAction>
      </bizsolo:otherwise>
    </bizsolo:choose>
...
<bizsolo:if test='<%= ! _PageName.equals(request.getParameter("_PageName")) %>'>
    ...
    <bizsolo:initDS name="CustomerCreditLimit" type="LONG"></bizsolo:initDS>
    ...
    <bizsolo:initDS name="SelectedVehicleModel" type="STRING"></bizsolo:initDS>
    <bizsolo:initDS name="VehicleBrand" type="STRING"></bizsolo:initDS>
    <bizsolo:executeAction epClassName="com.savvion.BizSolo.beans.PAKGetDS" perfMethod="commit" mode="BizSite" dso="VehicleBrand,SelectedVehicleModel,CreditApproval,DealerCode,CustomerOrderDate,CustomerName,CustomerCreditLimit"></bizsolo:executeAction>
</bizsolo:if>
...
<tr>
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_INSTRUCTION_LABEL"></bizsolo:getLabel></td><td width="15%" class="ApSegGenData" colspan="5"><sbm:message key="workstep.CreditCheck.instruction" escapeLine="true"></sbm:message></td>
</tr>
<tr>
...
<td width="15%" class="ApSegGenLabel"><bizsolo:getLabel type="RESOURCE" name="BIZSITE_DUEDATE_LABEL"></bizsolo:getLabel></td><td width="15%" class="ApSegGenData"><bizsolo:getDS name="bizsite_dueDate"></bizsolo:getDS></td>
      ...
      <tbody>
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <Label class="ApSegDataslotLabel" for="checkBox1"><sbm:message key="dataslot.CreditCheck.CreditApproval.label"></sbm:message></Label>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <div style="display: inline;" id="checkBox1"><input type="checkbox" class="ApInptChkBox" name="_UNBOUND_checkBox1" value="" id="checkBox1"></div>
        ...
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <Label class="ApSegDataslotLabel" for="textField1"><sbm:message key="dataslot.CustomerCreditLimit.label"></sbm:message></Label>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <input class="ApInptTxt" type="text" id="textField1" name="CustomerCreditLimit" size="30" maxlength="256" value="<bizsolo:value name='CustomerCreditLimit'/>" alt="number|0|bok">
    <div style="display:none" id="textField1Error"><div><font color="red"><span class="error" id="textField1ErrorMsg"></span><a href="#" onclick="textField1ErrorMsgClose();return false;"><img border="0" src="<c:out value='${contextPath}'/>bpmportal/css/apptheme01/images/close.gif"></a></font></div></div>
        ...
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <Label class="ApSegDataslotLabel" for="textField2"><sbm:message key="dataslot.CreditCheck.CustomerName.label"></sbm:message></Label>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <input class="ApInptTxt" type="text" id="textField2" name="CustomerName" size="20" maxlength="256" value="<bizsolo:value name='CustomerName'/>">
    <div style="display:none" id="textField2Error"><div><font color="red"><span class="error" id="textField2ErrorMsg"></span><a href="#" onclick="textField2ErrorMsgClose();return false;"><img border="0" src="<c:out value='${contextPath}'/>bpmportal/css/apptheme01/images/close.gif"></a></font></div></div>
        ...
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <Label class="ApSegDataslotLabel" for="CustomerOrderDate"><sbm:message key="dataslot.CreditCheck.CustomerOrderDate.label"></sbm:message></Label>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <div style="display: inline;" id="dateTime1"><bizsolo:getDS type="date" name="CustomerOrderDate" wsName="CreditCheck" size="20"></bizsolo:getDS></div>

          </td>
        </tr>
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <Label class="ApSegDataslotLabel" for="textField3"><sbm:message key="dataslot.CreditCheck.DealerCode.label"></sbm:message></Label>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <input class="ApInptTxt" type="text" id="textField3" name="DealerCode" size="20" maxlength="256" value="<bizsolo:value name='DealerCode'/>">
    <div style="display:none" id="textField3Error"><div><font color="red"><span class="error" id="textField3ErrorMsg"></span><a href="#" onclick="textField3ErrorMsgClose();return false;"><img border="0" src="<c:out value='${contextPath}'/>bpmportal/css/apptheme01/images/close.gif"></a></font></div></div>
        ...
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <Label class="ApSegDataslotLabel" for=""><sbm:message key="dataslot.CreditCheck.CreditApproval.label"></sbm:message></Label>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <input type="checkbox" value="true" class="ApInptChkBox" name="CreditApproval" id="checkBox2_V1">
<script>addValue("CreditApproval", '<bizsolo:value name="CreditApproval"></bizsolo:value>');</script>
        ...
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <Label class="ApSegDataslotLabel" for="textField4"><sbm:message key="dataslot.CreditCheck.SelectedVehicleModel.label"></sbm:message></Label>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <input class="ApInptTxt" type="text" id="textField4" name="SelectedVehicleModel" size="20" maxlength="256" value="<bizsolo:value name='SelectedVehicleModel'/>">
    <div style="display:none" id="textField4Error"><div><font color="red"><span class="error" id="textField4ErrorMsg"></span><a href="#" onclick="textField4ErrorMsgClose();return false;"><img border="0" src="<c:out value='${contextPath}'/>bpmportal/css/apptheme01/images/close.gif"></a></font></div></div>
        ...
        <tr>
          <td class="ApSegGenLabel" width="100" rowspan="1" colspan="1" valign="top">
            <Label class="ApSegDataslotLabel" for="textField5"><sbm:message key="dataslot.CreditCheck.VehicleBrand.label"></sbm:message></Label>
          </td>
          <td class="ApSegDataVal" width="100%" rowspan="1" colspan="1" valign="top">
            <input class="ApInptTxt" type="text" id="textField5" name="VehicleBrand" size="20" maxlength="256" value="<bizsolo:value name='VehicleBrand'/>">
