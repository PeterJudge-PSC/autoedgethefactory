...
<input name="crtPage" type="hidden" value="ReviewSelection"><input name="crtApp" type="hidden" value="VehicleSelection"><input name="activityMode" type="hidden" value="procReq"><input type="hidden" name="nextPage" value="Start.jsp">
...
<!-- Content --> 
    ...
    <div align="left" id="">
      <fieldset name="fsReview11">
        <legend><sbm:message key="ReviewSelection.fieldset.fsReview11.label"></sbm:message></legend>
        <div align="center" id="">
        ...
        <div align="left" id="">
          <br clear="all">
<table align="center" cellpadding="0" cellspacing="0" class="(default)" id="tblSelections" width="60%">
            <tbody>
              <tr>
                ...
                <td class="(default)" width="65%" rowspan="1" colspan="1" valign="top">
              ...
              <tr>
                ...
                <td class="(default)" width="10" rowspan="1" colspan="1" valign="top"></td>
                <td class="(default)" width="65%" rowspan="1" colspan="1" valign="top">
                  <sfe:widget name="sbm.textfield" id="TextField1" args="{'type':'Label', 'size':32, 'maxlength':50, 'readonly':true, 'disabled':false, 'required':false, 'validationType':'none', 'validation':{}, 'toolTip':'Savvion text field widget.', 'tabOrder':'0'}" />
              ...
              <tr>
                <td class="(default)" width="30%" rowspan="1" colspan="1" valign="top">
                  <div align="right" id="">
                    <font color="#808080" face="Segoe UI" size="3">Paint Color</font>
                  </div>
                </td>
                <td class="(default)" width="10" rowspan="1" colspan="1" valign="top"></td>
                <td class="(default)" width="65%" rowspan="1" colspan="1" valign="top">
                  <sfe:widget name="sbm.radio" id="rsExtColour" args="{'layout':'Horizontal', 'readonly':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'Savvion Radio widget.'}" />
              ...
              <tr>
                ...
                <td class="(default)" width="10" rowspan="1" colspan="1" valign="top"></td>
                <td class="(default)" width="65%" rowspan="1" colspan="1" valign="top">
                  <sfe:widget name="sbm.radio" id="rsWheels" args="{'layout':'Horizontal', 'readonly':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'Savvion Radio widget.'}" />
              ...
              <tr>
                ...
                <td class="(default)" width="10" rowspan="1" colspan="1" valign="top"></td>
                <td class="(default)" width="65%" rowspan="1" colspan="1" valign="top">
                  <sfe:widget name="sbm.radio" id="rsMoonroof" args="{'layout':'Horizontal', 'readonly':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'Savvion Radio widget.'}" />
              ...
              <tr>
                ...
                <td class="(default)" width="10" rowspan="1" colspan="1" valign="top"></td>
                <td class="(default)" width="65%" rowspan="1" colspan="1" valign="top">
                  <sfe:widget name="sbm.radio" id="rsSeatMaterial" args="{'layout':'Horizontal', 'readonly':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'Savvion Radio widget.'}" />
              ...
              <tr>
                <td class="(default)" width="30%" rowspan="1" colspan="1" valign="top">
                  <div align="right" id="">
                    <font color="#808080" face="Segoe UI" size="3">Trim Color</font>
                  </div>
                </td>
                <td class="(default)" width="10" rowspan="1" colspan="1" valign="top"></td>
                <td class="(default)" width="65%" rowspan="1" colspan="1" valign="top">
                  <sfe:widget name="sbm.radio" id="rsIntColour" args="{'layout':'Horizontal', 'readonly':true, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'Savvion Radio widget.'}" />
      ...
      <fieldset name="fsDealer">
        <legend><sbm:message key="ReviewSelection.fieldset.fsDealer.label"></sbm:message></legend>
        <div align="center" id="">
          ...
          <br clear="all">
<sfe:widget name="sbm.radio" id="rsDealer" args="{'layout':'Horizontal', 'readonly':false, 'disabled':false, 'validationType':'none', 'validation':{}, 'toolTip':'Savvion Radio widget.'}" />
...
{widget:'TextField1', bound:'true', editable:'false', type:'sbm.textfield', source: {type:'DATASLOT', dataSlotName:'ModelName', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'', dataSlotType:''}, dsType:'STRING', service:'false'},
...
{widget:'rsDealer', bound:'true', editable:'true', type:'sbm.radio', source: {type:'DATASLOT', dataSlotName:'DealerList', dataSlotType:'STRING'}, target:{type:'DATASLOT', dataSlotName:'DealerList', dataSlotType:'STRING'}, dsType:'STRING', service:'false'}
];
var businessObjects = [];
